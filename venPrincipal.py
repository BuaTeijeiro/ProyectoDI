...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("img/logo.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.btnCalendarcli = QtWidgets.QTableWidget(parent=self.pesClientes)
        self.btnCalendarcli.setObjectName("btnCalendarcli")
        self.btnCalendarcli.setColumnCount(0)
        self.btnCalendarcli.setRowCount(0)
        self.gridLayout_4.addWidget(self.btnCalendarcli, 4, 1, 1, 1)
        ...
        self.checkBox = QtWidgets.QCheckBox(parent=self.pesClientes)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout.addWidget(self.checkBox, 1, 10, 1, 1, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.btnCalendarcli_2 = QtWidgets.QPushButton(parent=self.pesClientes)
        self.btnCalendarcli_2.setMinimumSize(QtCore.QSize(24, 24))
        self.btnCalendarcli_2.setMaximumSize(QtCore.QSize(24, 24))
        self.btnCalendarcli_2.setStyleSheet("background-color: #FFF")
        self.btnCalendarcli_2.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("img/calendar.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btnCalendarcli_2.setIcon(icon1)
        self.btnCalendarcli_2.setIconSize(QtCore.QSize(24, 24))
        self.btnCalendarcli_2.setObjectName("btnCalendarcli_2")
        self.gridLayout.addWidget(self.btnCalendarcli_2, 0, 7, 1, 1)
